<template>
  <div class="wrapper">
    ...
    <div class="wrapper__input">
      <input type="password" class="wrapper__input__content" placeholder="确认密码" autocomplete="new-password" v-model="ensure">
    </div>
...
export default {
  ...
  setup () {
    ...
    return { username, password, ensure, show, toastMessage, handleRegister, handleLoginClick }
  }
}
</script>
